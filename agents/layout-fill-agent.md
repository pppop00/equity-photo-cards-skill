...
2. **Preserve the upstream agents' structure:** same slot keys; same counts (`metrics_row` 3-4, `background_bullets` 4, `porter_evidence` 5, `five_year_arc.inflection_points` 3-4, `recent_financial_highlights` 3-4, `revenue_explainer_points` 3-4, `cfa_lens.company_application` 3-4).
...
- **Card 3 five_year_arc.narrative overflows:** Cap at 200 chars; trim the inflection_points instead if the narrative itself is essential.
